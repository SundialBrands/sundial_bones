						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<article id="cAc_wfs-sample-<?php the_ID(); ?>" <?php post_class('cf'); ?> role="article" itemscope itemprop="blogPost" itemtype="http://schema.org/BlogPosting">
								...
								<header class="article-header entry-header cAc_wfs-sample-header">
									...
									<?php if( !empty( $sample_data['ingredient_two']['image_url'] ) ) { 
										echo '<img src="' . $sample_data['ingredient_two']['image_url'] . '" class="cAc_wfs-sample-img-ingredient header-left" />'; 
									} ?>
								...
								<?php
									...
									the_content();
								?>
									<?php if( !empty( $sample_data['ingredient_three']['image_url'] ) ) { echo '<img src="' . $sample_data['ingredient_three']['image_url'] . '" class="cAc_wfs-sample-img-ingredient body-left" />'; } ?>
									<?php if( !empty( $sample_data['ingredient_one']['image_url'] ) ) { echo '<img src="' . $sample_data['ingredient_one']['image_url'] . '" class="cAc_wfs-sample-img-ingredient body-right" />'; } ?>
								</div>
								<hr />
								...
								<footer class="article-footer cAc_wfs-sample-footer">
									...
									<div class="cAc_wfs-sample-cta box <?php echo $sample_data['color']; ?>">
										...
										<?php $atts=array(); echo cac_wfs_sampleform($atts); ?>
